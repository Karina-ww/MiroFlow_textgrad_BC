...
class ChatOpenAI(EngineLM, CachedEngine):
    ...
    def __init__(
        ...
        **kwargs):
        ...
        if not base_url or os.getenv("OPENAI_BASE_URL"):
    ...
    def _generate_from_single_prompt(
        self, prompt: str, system_prompt: str=None, temperature=0, max_tokens=32768, top_p=0.99, use_cache=False
    ):
